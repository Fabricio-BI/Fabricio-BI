...
* **Lenguajes:** Python (Pandas, NumPy, FuzzyWuzzy), SQL Server.
* **Business Intelligence:** Power BI (DAX, Power Query), Excel Avanzado.
* **Especialidad:** Automatización de Reportería Financiera, Ciclo Contable, Conciliaciones Masivas y Auditoría de Datos.
